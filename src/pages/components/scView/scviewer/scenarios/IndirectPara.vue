...
<script lang="ts">
    ...
    import {CableType, ComplexCableInfo, OneLineCableInfo, Point, SimpleCableInfo} from "@/ts/types/svg-types";
    import CableVue from "@/pages/components/scView/scviewer/sg-elements/CableVue.vue";
    import MeterVue from "@/pages/components/scView/scviewer/sg-elements/MeterVue.vue";
    import FuseVue from "@/pages/components/scView/scviewer/sg-elements/FuseVue.vue";
    import InfoLayerFuse from "@/pages/components/scView/scviewer/infoLayer/InfoLayerFuse.vue";
    import InfoLayerCable from "@/pages/components/scView/scviewer/infoLayer/InfoLayerCable.vue";
    import {Scenario} from "@/ts/scenario";
