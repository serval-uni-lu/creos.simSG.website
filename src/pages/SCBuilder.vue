...
<script lang="ts">
    ...
    import EditableInspector from "@/pages/components/inspector/EditableInspector.vue";
    import GridState, {DataConnCblMeter, DataNewCable, DataNewEntity} from "@/store/modules/grid-state";
    import {CableJson, EntityJson, GridJson, MeterJson} from "@/ts/types/sg-json.types";
