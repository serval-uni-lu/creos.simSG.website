/**
 * Implementation of a websocket client for the commuication with the server
 */
import {Message, ActionListMsg, LoadApproximationAnswer, ULoadApproximationAnswer} from "@/ts/types/ws-message";
import Vue from 'vue'
import {ActionData} from "@/ts/utils/action-utils";

//WARNING: be sure it matches the definition done on the server: https://github.com/UL-SnT-Serval/creos.simSG.api/blob/master/server/ws/src/main/java/creos/simsg/api/server/ws/RunServer.java
