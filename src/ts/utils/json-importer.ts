/**
 * Set of function to import Json formatted grid to GridData object.
 * This object will then be used to set the different parameters of the GridState store
 * (see src/store/modules/grid-state.ts).
 */
